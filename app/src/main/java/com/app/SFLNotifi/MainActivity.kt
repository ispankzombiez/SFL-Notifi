...
import com.app.SFLNotifi.api.*
import com.app.SFLNotifi.databinding.ActivityMainBinding
import com.app.SFLNotifi.databinding.ActivityMainSequentialBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        refreshReceiver = object : BroadcastReceiver() {
            override fun onReceive(context: Context?, intent: Intent?) {
                if (intent?.action == "com.app.SFLNotifi.REFRESH_VIEW") {
        ...
        val filter = IntentFilter("com.app.SFLNotifi.REFRESH_VIEW")
